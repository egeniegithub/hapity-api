...
Route::get('view-broadcast/{id}', 'Web\AntMediaBroadcastsController@view_broadcast')->name('broadcast.view');
...
// redirect new forget password route
Route::get('home/forget_password',function(){
    return redirect()->route('password.request');
});

// Route::get('widget', 'Web\WidgetController@index')->name('widget.index');

Route::get('widget', 'Web\WidgetController@ant_media_widget')->name('widget.index');
