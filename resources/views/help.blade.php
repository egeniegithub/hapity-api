...
@push('css')
    ...
    <style>
        ...
        .col-md-6.video-lg .embed-responsive-16by9 {
...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="main-heading text-center">
                        ...
                        <h4><strong>Please Note</strong> Hapity is not suitable for CCTV or Adult Services. Our fair use
                            policy permits us to cut off and not store over long livestreams.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 video-lg">
                    ...
                    <div
                        class="slide-vector embed-responsive embed-responsive-16by9"> <!-- <img src="{{asset('/')}}home/images/play-video.png" alt="Video Frame"> -->
                        ...
                        <div class="row no-margin">
                            <div class="col-md-6 no-padding">
                                <div class="download-guide text-center">
                                    <a href="{{asset('assets')}}/docs/help-docs/Hapity for WordPress.docx"
                                       target="_blank">
                                        <ul>
                                            <li><img src="{{asset('assets')}}/images/download-guide.png" alt="logo">
                                            </li>
                            ...
                            <div class="col-md-6 no-padding">
                                <div class="download-plugin text-center">
                                    <a href="https://wordpress.org/plugins/wp-hapity/">
                                        <ul>
                                            <li><img src="{{asset('assets')}}/images/download-plugin.png" alt="logo">
                                            </li>
                    ...
                    <div class="transcript-bottom text-center">
                        <a href="{{asset('assets')}}/docs/Hapity Installtion Guide-Wordpress Script.pdf"
                           target="_blank">
                ...
                <div class="col-md-6 video-lg">
                    ...
                    <div
                        class="slide-vector embed-responsive embed-responsive-16by9"> <!-- <img src="{{asset('assets/')}}home/images/play-video.png" alt="Video Frame"> -->
                        <video id="video2" controls poster="{{asset('assets')}}/images/integrate-with-drupal.jpg"
                               src="{{asset('assets')}}/videos/How_To_Drupal_Edit03-Vimeo_720p.mov"></video>
                    </div>
                    <div class="download-buttons-stuff">
                        <div class="row no-margin">
                            <div class="col-md-6 no-padding">
                ...
                <div class="col-md-6 video-lg">
                    ...
                    <div
                        class="slide-vector embed-responsive embed-responsive-16by9"> <!-- <img src="{{asset('/')}}('assets/'); ?>/home/images/play-video.png" alt="Video Frame"> -->
                        <video id="video3" controls poster="{{asset('assets')}}/images/integrate-with-joomla.jpg"
                               src="{{asset('assets')}}/videos/How-To_Joomla_Edit03_Vimeo_720p.mov"></video>
                    </div>
                    <div class="download-buttons-stuff">
                        <div class="row no-margin">
                            <div class="col-md-6 no-padding">
                ...
                {{--<div class="col-md-6 video-lg">
                    ...
                    <div
                        class="slide-vector embed-responsive embed-responsive-16by9"> <!-- <img src="{{asset('/')}}('assets/'); ?>/home/images/play-video.png" alt="Video Frame"> -->
                        <video id="video3" controls poster="{{asset('assets')}}/images/obs.png"
                               src="{{asset('assets')}}/videos/Hapity-OBS-Tutorial-HD-1080p.mov"></video>
                    </div>
                    <div class="transcript-bottom text-center">
                        <a href="javascript::void()">
                            <p><h4><span>Transcript</span></h4></p>
                ...
                <div class="col-md-6 video-lg">
                    ...
                    <div
                        class="slide-vector embed-responsive embed-responsive-16by9"> <!-- <img src="{{asset('/')}}('assets/'); ?>/home/images/play-video.png" alt="Video Frame"> -->
                        <video id="video3" controls poster="{{asset('assets')}}/images/youtube.png"
                               src="{{asset('assets')}}/videos/Hapity-YT-Tutorial-HD-1080p.mov"></video>
                    </div>
                    <div class="transcript-bottom text-center">
                        <a href="javascript::void()">
                            <p><h4><span>Transcript</span></h4></p>
            ...
            <div class="row">
                ...
                <div class="col-md-4 video-lg">
                    ...
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video4" controls poster="{{asset('assets')}}/images/guide-for-mobiles.jpg"
                               src="{{asset('assets')}}/videos/Hapity_Mobile_Guide_Edit02-Vimeo_720p.mov"></video>
                    </div>
                    <div class="download-buttons-stuff">
                        <div class="row no-margin">
                            <div class="col-md-12 no-padding">
                ...
                <div class="col-md-4 video-lg">
                    ...
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video5" controls poster="{{asset('assets')}}/images/broadcasting-from-your-pc.jpg"
                               src="{{asset('assets')}}/videos/Hapity_PC_Guide_Edit02-Vimeo_720p.mov"></video>
                    </div>
                    <div class="download-buttons-stuff">
                        <div class="row no-margin">
                            <div class="col-md-12 no-padding">
    ...
    <!-- modal -video -->
    <div class="modal fade modal-dismiss" id="wp-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-close-cstm" role="document">
            ...
            <div class="modal-content">
                <div class="modal-body video-body">
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video1" controls poster="{{asset('assets')}}/videos/default-video.jpg"
                               src="{{asset('assets')}}/videos/How-To-WordPress_Edit03-Vimeo_720p.mov"></video>
                    </div>
    ...
    <div class="modal fade modal-dismiss" id="drupal-modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-close-cstm" role="document">
            ...
            <div class="modal-content">
                <div class="modal-body video-body">
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video2" controls poster="{{asset('assets')}}/videos/default-video.jpg"
                               src="{{asset('assets')}}/videos/How_To_Drupal_Edit03-Vimeo_720p.mov"></video>
                    </div>
    ...
    <div class="modal fade modal-dismiss" id="joomla-modal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-close-cstm" role="document">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-content">
                <div class="modal-body video-body">
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video3" controls poster="{{asset('assets')}}/videos/default-video.jpg"
                               src="{{asset('assets')}}/videos/How-To_Joomla_Edit03_Vimeo_720p.mov"></video>
                    </div>
    ...
    <div class="modal fade modal-dismiss" id="mob-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-close-cstm" role="document">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-content">
                <div class="modal-body video-body">
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video4" controls poster="{{asset('assets')}}/videos/default-video.jpg"
                               src="{{asset('assets')}}/videos/Hapity_Mobile_Guide_Edit02-Vimeo_720p.mov"></video>
                    </div>
    ...
    <div class="modal fade modal-dismiss" id="broadcast-modal" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-close-cstm" role="document">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-content">
                <div class="modal-body video-body">
                    <div class="slide-vector embed-responsive embed-responsive-16by9">
                        <video id="video5" controls poster="{{asset('assets')}}/videos/default-video.jpg"
                               src="{{asset('assets')}}/videos/Hapity_PC_Guide_Edit02-Vimeo_720p.mov"></video>
                    </div>
