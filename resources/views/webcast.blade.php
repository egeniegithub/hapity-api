                    ...
                    <div class="video-frame">
                        <div class="embed-responsive embed-responsive-16by9">  
                            ...
                            <object type="application/x-shockwave-flash" data="{{ asset('assets/VideoIO-3.3/VideoIO45.swf') }}" id="live-broadcast" width="100%" height="Auto">
                                ...
                                value="controls=true&live=true&url=rtmp://52.18.33.132:1935/live/{{ $time. '.stream' }}&publish={{ $time. '.stream' }}&record=true&cameraQuality=100&videoCodec=H264Avc&sound=true&volume=1&codec=pcma" />
                            </object>
                        </div>
                    </div>
